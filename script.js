$(document).ready(function(){
  ...
  $('.valentines-day').click(function(){
    ...
    $('.envelope').fadeOut(800, function() {
      ...
      // Crear y agregar dinámicamente el contenido de la carta
     /* var containerContent = $('<div class="container"><i class="fa fa-heart"></i><div class="contenido"><h1>Te amo</h1><p>Feliz día de San Valentín</p></div></div>');
